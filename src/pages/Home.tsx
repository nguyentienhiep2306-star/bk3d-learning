  ...
  return (
    <div className="space-y-10">
      <section className="grid items-center gap-8 py-8 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          <p className="mb-3 text-sm font-bold uppercase tracking-wide text-[#0f6f64]">Nền tảng đào tạo kỹ thuật</p>
          <h1 className="max-w-3xl text-4xl font-bold leading-tight text-[#172033] sm:text-5xl">BK3D giúp học viên học đúng khóa, đúng tiến độ, đúng năng lực.</h1>
          <p className="mt-5 max-w-2xl text-lg text-[#4d6378]">Quản lý khóa học, bài giảng YouTube Unlisted, tiến độ học và bài kiểm tra trên một hệ thống React + Supabase sẵn sàng triển khai tại bk3d.io.vn.</p>
